  ...
  <div class="page-wrapper">
    ...
    <footer class="main-footer style-three" style="background-color: #4c4c4c;">
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="main-footer_copyright">Copyright © 2024 <a href="./index.html">VYK Netwok Pvt. Ltd</a>, All Rights Reserved. Designed by <a href="izhtech.com">Izh-Tech</a></div>
            </div>
        </div>
    </footer>
    <!-- End Footer Style -->
